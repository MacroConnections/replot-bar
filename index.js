...
var _humanizePlus = __webpack_require__(8);
...
BarGraph.propTypes = {
  ...
  yAxis: _propTypes2.default.string,
  yScale: _propTypes2.default.string,
  yAxisStrokeW: _propTypes2.default.number,
  yAxisColor: _propTypes2.default.string,
  yTick: _propTypes2.default.string,
  yTickStrokeW: _propTypes2.default.number,
  yTickColor: _propTypes2.default.string,
  yTickLength: _propTypes2.default.number,
  gridline: _propTypes2.default.string,
  gridlineStrokeW: _propTypes2.default.number,
  gridlineColor: _propTypes2.default.string,
  gridlineOpacity: _propTypes2.default.number,
  xTitleColor: _propTypes2.default.string,
  xLabel: _propTypes2.default.string,
  xLabelColor: _propTypes2.default.string,
  yTitleColor: _propTypes2.default.string,
  yLabel: _propTypes2.default.string,
  yLabelColor: _propTypes2.default.string,
