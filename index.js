...
var BarContainer = function (_React$Component2) {
  _inherits(BarContainer, _React$Component2);

  function BarContainer() {
    _classCallCheck(this, BarContainer);

    return _possibleConstructorReturn(this, (BarContainer.__proto__ || Object.getPrototypeOf(BarContainer)).apply(this, arguments));
  }
    ...
    value: function render() {
      ...
      if (this.props.groupKey) {
        var groups = [].concat(_toConsumableArray(new Set(this.props.data.map(function (item) {
          return item[_this4.props.groupKey];
        }))));
        var groupWidth = this.props.width / groups.length;
        var paddedWidth = groupWidth / 1.5;
        barWidth = paddedWidth / this.props.xVals.length / 1.2;

        var xCoords = {};
        var x = (groupWidth - paddedWidth) / 2;
        var xVal = void 0;
        for (var i = 0; i < this.props.xVals.length; i++) {
        ...
        for (var _i = 0; _i < groups.length; _i++) {
          for (var j = 0; j < this.props.data.length; j++) {
            ...
            if (!isNaN(dataPoint[this.props.yKey]) && dataPoint[this.props.groupKey] === groups[_i]) {
        ...
        for (var _i2 = 0; _i2 < this.props.data.length; _i2++) {
          dataPoint = this.props.data[_i2];
          barX = this.props.width / this.props.data.length / 2 + _i2 * this.props.width / this.props.data.length;
          if (this.props.yScale === "log") {
            barHeight = Math.log10(dataPoint[this.props.yKey]) * unit;
          } else {
            barHeight = dataPoint[this.props.yKey] * unit;
...
var BarGraph = function (_React$Component3) {
  _inherits(BarGraph, _React$Component3);
  ...
  _createClass(BarGraph, [{
    ...
    key: "colorBar",
    value: function colorBar(i, value, group) {
    ...
    value: function render() {
      ...
      var xVals = [].concat(_toConsumableArray(new Set(this.props.data.map(function (item) {
        return item[_this6.props.xKey];
      }))));
      xVals = xVals.sort(function (a, b) {
        return a - b;
      });
      var yVals = this.props.data.map(function (item) {
        return item[_this6.props.yKey];
      });
      var maxY = Math.max.apply(Math, _toConsumableArray(yVals));
      var padY = maxY / 5;

      var xLabels = void 0;
      if (this.props.groupKey) {
        xLabels = [].concat(_toConsumableArray(new Set(this.props.data.map(function (item) {
          return item[_this6.props.groupKey];
        }))));
      } else {
        xLabels = xVals;
      }
      ...
      var graph = _react2.default.createElement(
        ...
        _react2.default.createElement(BarContainer, { data: this.props.data, groupKey: this.props.groupKey,
...
var BarGraphResponsive = function (_React$Component4) {
  _inherits(BarGraphResponsive, _React$Component4);

  function BarGraphResponsive() {
    _classCallCheck(this, BarGraphResponsive);

    return _possibleConstructorReturn(this, (BarGraphResponsive.__proto__ || Object.getPrototypeOf(BarGraphResponsive)).apply(this, arguments));
  }

  _createClass(BarGraphResponsive, [{
    key: "render",
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(BarGraph, this.props)
      );
    }
  }]);

  return BarGraphResponsive;
}(_react2.default.Component);
...
BarGraph.defaultProps = {
  ...
  width: 800,
  height: 600,
  color: ["#4cab92", "#ca0004", "#8e44ad", "#eccc00", "#9dbd5f", "#0097bf", "#005c7a", "#fc6000"],
  showXAxisLine: true,
  showXLabels: true,
  showYAxisLine: true,
  showYLabels: true,
...
var _BarGraph = __webpack_require__(15);
...
var _Motion = __webpack_require__(24);
